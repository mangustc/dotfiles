...
winget install Zen-Team.Zen-Browser --silent --accept-package-agreements --accept-source-agreements
...
winget install KDE.Okular --silent --accept-package-agreements --accept-source-agreements
