...
# def __hidcall(function, *args, **kwargs):
#     ret = function(*args, **kwargs)
#     return ret
#
# def read(size: int = MAX_REPORT_SIZE, timeout=None):
#     if timeout is None:
#         size = __hidcall(hidapi.hid_read, self._dev, self.buf, size)
#     else:
#         size = self.__hidcall(hidapi.hid_read_timeout, self._dev, self.buf, size, timeout)
#
