set color00 14/14/15 # Base 00 - Black
set color01 d8/64/7e # Base 08 - Red
set color02 99/b7/82 # Base 0B - Green
set color03 f5/cb/96 # Base 0A - Yellow
set color04 8b/a9/c1 # Base 0D - Blue
set color05 c9/b1/ca # Base 0E - Magenta
set color06 be/be/da # Base 0C - Cyan
set color07 cd/cd/cd # Base 05 - White
set color08 7f/a5/63 # Base 03 - Bright Black
...
set color15 cd/cd/cd # Base 07 - Bright White
set color16 f3/be/7c # Base 09
set color17 60/60/79 # Base 0F
set color18 25/25/30 # Base 01
set color19 60/60/79 # Base 02
set color20 bb/9d/bd # Base 04
set color21 d7/d7/d7 # Base 06
...
if test -n "$ITERM_SESSION_ID"
	...
	put_template_custom Ph 141415 # background
	put_template_custom Pi cdcdcd # bold color
	put_template_custom Pj 606079 # selection color
	put_template_custom Pk cdcdcd # selected text color
	put_template_custom Pl cdcdcd # cursor
	put_template_custom Pm 141415 # cursor text
else
...
set -U fish_color_autosuggestion 606079
set -U fish_color_cancel -r
set -U fish_color_command green #white
set -U fish_color_comment 606079
...
set -U fish_color_param bb9dbd
set -U fish_color_quote yellow #brblack
set -U fish_color_redirection cyan
set -U fish_color_search_match bryellow --background=606079
set -U fish_color_selection white --bold --background=606079
...
set -U base16_theme vague-kitty
